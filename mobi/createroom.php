...
<h1><?php $mesg?></h1>
<fieldset>
        	<legend><h1 class="big">Create a chat room</h1></legend>
	
		
		<input type="text" name="name" id="name" value="" placeholder="Name of group"autocomplete="off"/><br>
	...
	<input type="submit" value="Make the group" class="Main_buttons"/>
	</fieldset>
</form>