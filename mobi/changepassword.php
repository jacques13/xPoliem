...
<form action="" method="post" class="centerA upload">
	<div class="field big">
		<label for="currentPassword">Your existing Password</label><br>
	...
	<div class="field big">
		<label for="newPasswordAgain">Enter your new password again</label><br>
		<input type="password" name="newPasswordAgain" id="newPasswordAgain"/>
	</div><br>
	<input type="hidden" name="token" value="<?php echo Token::generate(); ?>"/>
	<input type="submit" value="Update" class="Main_buttons"/>
</form>