...
(function ($, window, document, undefined) {
    ...
    var settings = {
        ...
        channelInputElem: "#videoChannelInput1", // channel input textfield jQuery selector (see the rtcStatusUpdate.entry.statusHTML code)
        ...
        rtcStatusUpdate: {
            ...
            "entry": {
                ...
                statusFx: function ($this, statusType) { // displays channel entry form
                    ...
                    $("#videoChannelInput1").keyup(function (e) {
                        if (e.keyCode == 13) {
                            var $channelInput = $($this.opts.channelInputElem);
                            if ($channelInput.val().length <= 0) {
                                alert('Please enter a channel name to continue!');
            ...
            "waiting": {
                statusHTML: " <strong></strong> <span class='exit-channel'>(<a href='#' class='exit-channel-link'>Exit Chat</a>)</span><br>Waiting for another person to join ;",
